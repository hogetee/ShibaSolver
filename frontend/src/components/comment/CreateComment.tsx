...
export default function CreateComment({ placeholder = "Add a comment...", author, onSubmit }: CreateCommentProps) {
  ...
  const { attachedImagePreview, handleAttachImage, handleRemoveAttachment } = useCommentActions('create', 0, 0, false);
        ...
        <div className="mt-2 mb-1 flex items-start justify-start gap-4">
          ...
          {attachedImagePreview ? (
            <div className="relative w-20 h-20">
              <img src={attachedImagePreview} alt="attachment preview" className="object-cover w-20 h-20 rounded-md" />
              <button
                type="button"
                onClick={() => {
                  setLocalAttachedFile(null);
